...
class Instagram extends Component {
    ...
    handleChange = (ev) => {
        ...
        const sign = token.search('&')
        const newToken = token.substring(14, sign)
        console.log(newToken)
        this.setState({ token })
        this.props.history.push(`/instagram/${token}`)
...
if (typeof module === 'object' && typeof module.exports === 'object') {
  module.exports = SpotifyWebApi;
        ...
        .then(data => data.json())
        .then(state => this.state.setState({ state }))
        ...
        return(
            <div className="instagram">
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div>
                        <button type='success'
                        onClick={this.handleChange}>Display User</button>
                    </div>
                </form>

                <Route path='/instagram/:token' component={SpotifyUser}/>
            </div>
        )
    }
}
